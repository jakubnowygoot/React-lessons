...
- Na stronie [Font Squirrel](https://www.fontsquirrel.com/tools/webfont-generator) przejdź do generatora i załaduj do niego wyżej wymieniony font
...
- za pomocą `font-family` dodaj ten font do tytułu wszystkich nagłówków (`h1` - `h6`)
